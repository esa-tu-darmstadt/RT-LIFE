...
module mkRISCV_MBox(CLK,
  ...
  wire [63 : 0] SEXT_rg_v1____d103, rg_v1_MUL_rg_v2___d100, v1__h3090;
  wire [31 : 0] _theResult___fst__h727,
  ...
  assign denom___1__h669 = rg_v2[31] ? -rg_v2 : rg_v2 ;
  assign intDiv_rg_denom2_4_ULE_0_CONCAT_rg_v1_BITS_31__ETC___d47 =
	     intDiv_rg_denom2 <= y__h2430 ;
  assign numer___1__h668 = rg_v1[31] ? x__h2707 : rg_v1 ;
  ...
  assign v__h3123 =
	     (rg_is_OP_not_OP_32 && rg_f3 == 3'b010) ?
	       ...
	       32'hFFFFFFFF ;
  assign x__h2551 = rg_v1 - intDiv_rg_denom2 ;
  assign x__h2637 = -intDiv_rg_quo ;
  assign x__h2707 = -rg_v1 ;
  assign x__h2722 = intDiv_rg_quo + intDiv_rg_n ;
  assign y__h2430 = { 1'd0, rg_v1[31:1] } ;
  ...
  begin
    ...
    v__h3197 = v__h3203 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_mul &&
	  (!rg_is_OP_not_OP_32 ||
	   rg_f3 != 3'b0 && rg_f3 != 3'b001 && rg_f3 != 3'b011 &&
	   rg_f3 != 3'b010))
	$display("%0d: ERROR: RISCV_MBox.rl_mul: illegal f3.", v__h3197);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_mul &&
	  (!rg_is_OP_not_OP_32 ||
	   rg_f3 != 3'b0 && rg_f3 != 3'b001 && rg_f3 != 3'b011 &&
