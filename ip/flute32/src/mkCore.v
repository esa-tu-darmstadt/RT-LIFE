...
module mkCore(CLK,
  ...
  wire [100 : 0] cpu$dexie_dfmemdata_out_get;
  wire [95 : 0] cpu$dexie_cfdata_out_get;
  wire [68 : 0] cpu$dexie_dfregdata_out_get;
  ...
  wire cpu$EN_dexie_cfdata_out_get,
       cpu$EN_dexie_dfmemdata_out_get,
       cpu$EN_dexie_dfregdata_out_get,
       cpu$EN_hart0_server_reset_request_put,
       cpu$EN_hart0_server_reset_response_get,
       cpu$EN_set_verbosity,
       cpu$EN_trace_data_out_get,
       cpu$RDY_dexie_cfdata_out_get,
       cpu$RDY_dexie_dfmemdata_out_get,
       cpu$RDY_dexie_dfregdata_out_get,
       cpu$RDY_hart0_server_reset_request_put,
       cpu$RDY_hart0_server_reset_response_get,
       cpu$RDY_trace_data_out_get,
       cpu$dexie_continueStore_set_or_clear,
       cpu$dexie_stallOnStore_set_or_clear,
       cpu$dexie_stall_set_or_clear,
  ...
  // actionvalue method trace_data_out_get
  assign trace_data_out_get = cpu$trace_data_out_get ;
  assign RDY_trace_data_out_get = cpu$RDY_trace_data_out_get ;
  assign CAN_FIRE_trace_data_out_get = cpu$RDY_trace_data_out_get ;
  assign WILL_FIRE_trace_data_out_get = EN_trace_data_out_get ;

  // actionvalue method dexie_cfdata_out_get
  assign dexie_cfdata_out_get = cpu$dexie_cfdata_out_get ;
  assign RDY_dexie_cfdata_out_get = cpu$RDY_dexie_cfdata_out_get ;
  assign CAN_FIRE_dexie_cfdata_out_get = cpu$RDY_dexie_cfdata_out_get ;
  assign WILL_FIRE_dexie_cfdata_out_get = EN_dexie_cfdata_out_get ;

  // actionvalue method dexie_dfmemdata_out_get
  assign dexie_dfmemdata_out_get = cpu$dexie_dfmemdata_out_get ;
  assign RDY_dexie_dfmemdata_out_get = cpu$RDY_dexie_dfmemdata_out_get ;
  assign CAN_FIRE_dexie_dfmemdata_out_get = cpu$RDY_dexie_dfmemdata_out_get ;
  assign WILL_FIRE_dexie_dfmemdata_out_get = EN_dexie_dfmemdata_out_get ;

  // actionvalue method dexie_dfregdata_out_get
  assign dexie_dfregdata_out_get = cpu$dexie_dfregdata_out_get ;
  assign RDY_dexie_dfregdata_out_get = cpu$RDY_dexie_dfregdata_out_get ;
  assign CAN_FIRE_dexie_dfregdata_out_get = cpu$RDY_dexie_dfregdata_out_get ;
  ...
  mkCPU cpu(.CLK(CLK),
	    .RST_N(RST_N),
	    .dexie_continueStore_set_or_clear(cpu$dexie_continueStore_set_or_clear),
	    .dexie_stallOnStore_set_or_clear(cpu$dexie_stallOnStore_set_or_clear),
	    .dexie_stall_set_or_clear(cpu$dexie_stall_set_or_clear),
	    ...
	    .EN_dexie_cfdata_out_get(cpu$EN_dexie_cfdata_out_get),
	    .EN_dexie_dfmemdata_out_get(cpu$EN_dexie_dfmemdata_out_get),
	    .EN_dexie_dfregdata_out_get(cpu$EN_dexie_dfregdata_out_get),
	    ...
	    .dexie_cfdata_out_get(cpu$dexie_cfdata_out_get),
	    .RDY_dexie_cfdata_out_get(cpu$RDY_dexie_cfdata_out_get),
	    .dexie_dfmemdata_out_get(cpu$dexie_dfmemdata_out_get),
	    .RDY_dexie_dfmemdata_out_get(cpu$RDY_dexie_dfmemdata_out_get),
	    .dexie_dfregdata_out_get(cpu$dexie_dfregdata_out_get),
	    .RDY_dexie_dfregdata_out_get(cpu$RDY_dexie_dfregdata_out_get));
  ...
  // submodule cpu
  assign cpu$dexie_continueStore_set_or_clear =
	     dexie_continueStore_set_or_clear ;
  assign cpu$dexie_stallOnStore_set_or_clear =
	     dexie_stallOnStore_set_or_clear ;
  assign cpu$dexie_stall_set_or_clear = dexie_stall_set_or_clear ;
  ...
  assign cpu$EN_trace_data_out_get = EN_trace_data_out_get ;
  assign cpu$EN_dexie_cfdata_out_get = EN_dexie_cfdata_out_get ;
  assign cpu$EN_dexie_dfmemdata_out_get = EN_dexie_dfmemdata_out_get ;
  assign cpu$EN_dexie_dfregdata_out_get = EN_dexie_dfregdata_out_get ;
  ...
  begin
    ...
    v__h4295 = v__h4301 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h4295);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h4536);
  end
  // synopsys translate_on
endmodule  // mkCore
