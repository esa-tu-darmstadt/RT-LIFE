...
module mkCSR_RegFile(CLK,
  ...
  wire [31 : 0] IF_csr_ret_actions_from_priv_EQ_0b11_028_THEN__ETC___d1049,
		_theResult___fst__h8162,
		_theResult___fst__h8363,
		...
		mask__h8183,
		mask__h8200,
		new_csr_value__h4635,
		new_csr_value__h5291,
		v__h4443,
		v__h4505,
		v__h4676,
		val__h8201,
		vector_offset__h7195,
		wordxl1__h3972,
		x__h3766,
		x__h5794,
		x__h8018,
		...
		y__h8196,
		y__h8213;
  wire [22 : 0] fixed_up_val_23__h4013,
		fixed_up_val_23__h6422,
		fixed_up_val_23__h8081;
  wire [5 : 0] ie_from_x__h8146, pie_from_x__h8147;
  wire [3 : 0] IF_NOT_csr_mip_mv_read__91_BIT_11_276_323_OR_N_ETC___d1369,
	       ...
	       exc_code__h7860;
  wire [1 : 0] mpp__h7288, to_y__h8362;
  ...
  // actionvalue method mav_csr_write
  assign mav_csr_write = { x__h3766, 33'h0AAAAAAAA } ;
  ...
  // actionvalue method csr_trap_actions
  assign csr_trap_actions = { x__h5794, x__h8018, x__h8019, 2'b11 } ;
  ...
  assign MUX_rw_minstret$wset_1__VAL_1 =
	     (mav_csr_write_csr_addr == 12'hB02) ? x__h5108 : x__h5216 ;
  ...
  assign rg_tdata1$D_IN =
	     MUX_rg_tdata1$write_1__SEL_1 ? new_csr_value__h5291 : 32'd0 ;
  assign rg_tdata1$EN =
	     EN_mav_csr_write &&
	     mav_csr_write_csr_addr_ULT_0xB03_74_OR_NOT_mav_ETC___d587 &&
	     mav_csr_write_csr_addr == 12'h7A1 ||
  ...
  assign IF_csr_ret_actions_from_priv_EQ_0b11_028_THEN__ETC___d1067 =
		 ...
		 _theResult___fst__h8162 } :
	       { to_y__h8362, _theResult___fst__h8363 } ;
  ...
  assign NOT_csr_trap_actions_nmi_96_AND_csr_trap_actio_ETC___d973 =
	     !csr_trap_actions_nmi && csr_trap_actions_interrupt &&
	     exc_code__h7860 != 4'd0 &&
	     exc_code__h7860 != 4'd1 &&
	     exc_code__h7860 != 4'd2 &&
	     exc_code__h7860 != 4'd3 &&
	     exc_code__h7860 != 4'd4 &&
	     exc_code__h7860 != 4'd5 &&
	     exc_code__h7860 != 4'd6 &&
	     exc_code__h7860 != 4'd7 &&
	     exc_code__h7860 != 4'd8 &&
	     exc_code__h7860 != 4'd9 &&
	     exc_code__h7860 != 4'd10 &&
	     exc_code__h7860 != 4'd11 ;
  ...
  assign _theResult___fst__h8162 =
  ...
  assign _theResult___fst__h8363 =
  ...
  assign csr_trap_actions_nmi_OR_NOT_csr_trap_actions_i_ETC___d1024 =
	     ...
	     exc_code__h7860 != 4'd9 &&
	     exc_code__h7860 != 4'd11 &&
	     exc_code__h7860 != 4'd12 &&
	     exc_code__h7860 != 4'd13 &&
	     exc_code__h7860 != 4'd15 ;
  assign exc_code__h7860 =
	     csr_trap_actions_nmi ? 4'd0 : csr_trap_actions_exc_code ;
  assign exc_pc___1__h7247 = exc_pc__h7194 + vector_offset__h7195 ;
  assign exc_pc__h6983 = { rg_mtvec[30:1], 2'd0 } ;
  assign exc_pc__h7194 =
	     csr_trap_actions_nmi ? rg_nmi_vector : exc_pc__h6983 ;
  assign fixed_up_val_23__h4013 =
  ...
  assign fixed_up_val_23__h8081 =
		...
		2'b11) ?
		 ...
		 2'b0,
	       ...
	       2'd0 } ;
  assign ie_from_x__h8146 = { 4'd0, csr_ret_actions_from_priv } ;
  assign mask__h8183 = 32'd1 << pie_from_x__h8147 ;
  assign mask__h8200 = 32'd1 << ie_from_x__h8146 ;
  ...
  assign mpp__h7288 =
	     (csr_trap_actions_from_priv == 2'b11) ?
	       csr_trap_actions_from_priv :
	       2'b0 ;
  assign new_csr_value__h4635 = { mav_csr_write_word[31:1], 1'd0 } ;
  assign new_csr_value__h5291 = { 4'd0, mav_csr_write_word[27:0] } ;
  assign pie_from_x__h8147 = { 4'd1, csr_ret_actions_from_priv } ;
  assign to_y__h8362 =
	     { 1'b0,
	       csr_mstatus_rg_mstatus_76_AND_INV_1_SL_0_CONCA_ETC___d1042[8] } ;
  assign v__h4443 =
	     { mav_csr_write_word[31:2], 1'b0, mav_csr_write_word[0] } ;
  assign v__h4505 = { 29'd0, mav_csr_write_word[2:0] } ;
  assign v__h4676 =
	     { mav_csr_write_word[31], 27'd0, mav_csr_write_word[3:0] } ;
  assign val__h8201 = { 31'd0, b__h8199 } << ie_from_x__h8146 ;
  assign vector_offset__h7195 = { 26'd0, csr_trap_actions_exc_code, 2'd0 } ;
  assign wordxl1__h3972 = { 9'd0, fixed_up_val_23__h4013 } ;
  assign x__h3766 =
	     NOT_mav_csr_write_csr_addr_ULT_0xB03_74_33_AND_ETC___d744 ?
	       32'd0 :
	       IF_mav_csr_write_csr_addr_EQ_0x300_88_THEN_0_C_ETC___d767 ;
  assign x__h5108 = { rg_minstret[63:32], mav_csr_write_word } ;
  assign x__h5216 = { mav_csr_write_word, rg_minstret[31:0] } ;
  assign x__h5794 =
	     (csr_trap_actions_interrupt && !csr_trap_actions_nmi &&
	      rg_mtvec[0]) ?
	       exc_pc___1__h7247 :
	       exc_pc__h7194 ;
  assign x__h8018 = { 9'd0, fixed_up_val_23__h6422 } ;
  assign x__h8019 =
	     { !csr_trap_actions_nmi && csr_trap_actions_interrupt,
	       27'd0,
	       exc_code__h7860 } ;
  assign x__h8182 = x__h8212 | val__h8201 ;
  assign x__h8195 = x__h8182 & y__h8196 ;
  assign x__h8212 = csr_mstatus_rg_mstatus & y__h8213 ;
  assign y__h8196 = ~mask__h8183 ;
  assign y__h8213 = ~mask__h8200 ;
  always@(mav_csr_write_csr_addr or
	  ...
	  v__h4443 or
	  v__h4505 or
	  new_csr_value__h4635 or
	  v__h4676 or csr_mip$mav_write or new_csr_value__h5291)
  begin
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__29_ULE_1_30___d731)
	$write("    Return: new pc 0x%0h  ", x__h5794);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__29_ULE_1_30___d731)
	$write(" new mstatus:");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__29_ULE_1_30___d731 &&
	  NOT_csr_trap_actions_nmi_96_AND_csr_trap_actio_ETC___d973)
	$write("unknown interrupt Exc_Code %d", exc_code__h7860);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__29_ULE_1_30___d731 &&
	  (csr_trap_actions_nmi || !csr_trap_actions_interrupt) &&
	  exc_code__h7860 == 4'd0)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__29_ULE_1_30___d731 &&
	  csr_trap_actions_nmi_OR_NOT_csr_trap_actions_i_ETC___d1024)
	$write("unknown trap Exc_Code %d", exc_code__h7860);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__29_ULE_1_30___d731)
