...
// m_is_mem_addr                  O     1 const
// m_is_IO_addr                   O     1 const
// m_is_near_mem_IO_addr          O     1 const
// m_pc_reset_value               O    64 const
// m_mtvec_reset_value            O    64 const
// m_nmivec_reset_value           O    64 const
// CLK                            I     1 unused
// RST_N                          I     1 unused
// m_is_mem_addr_addr             I    64 unused
// m_is_IO_addr_addr              I    64 unused
// m_is_near_mem_IO_addr_addr     I    64 unused
//
...
module mkSoC_Map(CLK,
  ...
  // value method m_near_mem_io_addr_base
  assign m_near_mem_io_addr_base = 64'h0000000000010000 ;

  // value method m_near_mem_io_addr_size
  assign m_near_mem_io_addr_size = 64'h0 ;

  // value method m_near_mem_io_addr_lim
  assign m_near_mem_io_addr_lim = 64'd65536 ;

  // value method m_plic_addr_base
  assign m_plic_addr_base = 64'h000000000C000000 ;

  // value method m_plic_addr_size
  assign m_plic_addr_size = 64'h0 ;

  // value method m_plic_addr_lim
  assign m_plic_addr_lim = 64'd201326592 ;

  // value method m_uart0_addr_base
  assign m_uart0_addr_base = 64'h0000000000100000 ;

  // value method m_uart0_addr_size
  assign m_uart0_addr_size = 64'h000000007FF00080 ;

  // value method m_uart0_addr_lim
  assign m_uart0_addr_lim = 64'h0000000080000080 ;

  // value method m_boot_rom_addr_base
  assign m_boot_rom_addr_base = 64'h0 ;

  // value method m_boot_rom_addr_size
  assign m_boot_rom_addr_size = 64'h0000000000010000 ;

  // value method m_boot_rom_addr_lim
  assign m_boot_rom_addr_lim = 64'd65536 ;
  ...
  // value method m_is_mem_addr
  assign m_is_mem_addr = 1'd0 ;

  // value method m_is_IO_addr
  assign m_is_IO_addr = 1'd1 ;

  // value method m_is_near_mem_IO_addr
  assign m_is_near_mem_IO_addr = 1'd0 ;
