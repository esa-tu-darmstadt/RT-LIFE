...
module mkBranch_Predictor(CLK,
  ...
  reg [31 : 0] _theResult_____1_fst__h7533,
	       _theResult_____1_fst__h7577,
	       pred_PC__h7438;
  reg [1 : 0] _theResult_____1_snd__h7534, _theResult_____1_snd__h7578;
  ...
  wire [31 : 0] _theResult_____1__h2384,
		_theResult_____1_fst__h7466,
		_theResult____h2383,
		pred_pc__h3355,
		pred_pc__h3357,
		ret_pc___1__h4110,
		ret_pc__h4072;
  wire [1 : 0] _theResult_____1_snd__h7467;
  ...
  // value method predict_rsp
  assign predict_rsp =
	     (_theResult_____1__h2384 == 32'hFFFFFFFF) ?
	       pred_pc__h3357 :
  ...
  assign MUX_btb_bramcore2$b_put_1__SEL_1 =
	     EN_bp_train && pred_PC__h7438 != 32'hFFFFFFFF ;
  assign MUX_btb_bramcore2$b_put_3__VAL_1 =
	     { 1'd1, bp_train_cf_info[96:75], pred_PC__h7438[31:1] } ;
  always@(bp_train_cf_info or
	  rf_btb_fsms$D_OUT_1 or _theResult_____1_snd__h7467)
  begin
    case (bp_train_cf_info[98:97])
      2'd0: MUX_rf_btb_fsms$upd_2__VAL_1 = _theResult_____1_snd__h7467;
  ...
  assign IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d229 =
	     { IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d225,
	       bp_train_is_i32_not_i16 ? ret_pc__h4072 : ret_pc___1__h4110 } ;
  ...
  assign _theResult_____1__h2384 =
	     (_theResult____h2383 == 32'hFFFFFFFF && btb_bramcore2$DOA[53] &&
	      btb_bramcore2$DOA[52:31] == rg_pc[31:10]) ?
	       pred_pc__h3355 :
	       _theResult____h2383 ;
  assign _theResult_____1_fst__h7466 =
	     bp_train_cf_info[64] ?
	       _theResult_____1_fst__h7533 :
	       _theResult_____1_fst__h7577 ;
  assign _theResult_____1_snd__h7467 =
	     bp_train_cf_info[64] ?
	       _theResult_____1_snd__h7534 :
	       _theResult_____1_snd__h7578 ;
  ...
  assign bp_train_instr_BITS_15_TO_12_25_EQ_0b1001_38_A_ETC___d157 =
	     ...
	     bp_train_instr[6:2] == 5'd0 &&
	     bp_train_instr[1:0] == 2'b10 ;
  assign pred_pc__h3355 = { btb_bramcore2$DOA[30:0], 1'b0 } ;
  assign pred_pc__h3357 =
  ...
  assign predict_rsp_instr_BITS_15_TO_12_9_EQ_0b1001_0__ETC___d33 =
	     ...
	     predict_rsp_instr[6:2] == 5'd0 &&
	     predict_rsp_instr[1:0] == 2'b10 ;
  assign ret_pc___1__h4110 = bp_train_pc + 32'd2 ;
  assign ret_pc__h4072 = bp_train_pc + 32'd4 ;
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_fst__h7533 = bp_train_cf_info[63:32];
      2'b01, 2'b10, 2'b11:
	  _theResult_____1_fst__h7533 = bp_train_cf_info[31:0];
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01, 2'b10:
	  _theResult_____1_fst__h7577 = bp_train_cf_info[63:32];
      2'b11: _theResult_____1_fst__h7577 = bp_train_cf_info[31:0];
    endcase
  end
  always@(bp_train_cf_info or _theResult_____1_fst__h7466)
  begin
    case (bp_train_cf_info[98:97])
      2'd0: pred_PC__h7438 = _theResult_____1_fst__h7466;
      2'd1, 2'd2: pred_PC__h7438 = bp_train_cf_info[31:0];
      2'd3: pred_PC__h7438 = 32'hFFFFFFFF;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_snd__h7534 = 2'b01;
      2'b01: _theResult_____1_snd__h7534 = 2'b10;
      2'b10, 2'b11: _theResult_____1_snd__h7534 = 2'b11;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01: _theResult_____1_snd__h7578 = 2'b0;
      2'b10: _theResult_____1_snd__h7578 = 2'b01;
      2'b11: _theResult_____1_snd__h7578 = 2'b10;
    endcase
  end
